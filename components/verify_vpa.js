...
//curl -X GET http://localhost:3002/vpa/verify/adityajain27@ybl
//for post man -> http://localhost:3002/vpa/verify/adityajain27@ybl
...
module.exports = async function (req, res) {
  ...
  const endpoint = `/v3/vpa/${MERCHANT_ID}/${vpa}/validate`;
  ...
  try {
    ...
    console.log("PhonePe VPA validation response:", response.data);
