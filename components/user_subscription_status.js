// 1)use this command da in command prompt or use postman 
// 2)by using sub id from create subscription
//curl -X GET http://localhost:3002/subscription/validate/{subscriptionId}
...
module.exports = async function (req, res) {
  ...
  const endpoint = `/v3/recurring/subscription/status/${MERCHANT_ID}/${subscriptionId}`;
  ...
  try {
    ...
    console.log("PhonePe subscription validation response:", response.data);
